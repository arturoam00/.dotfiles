...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}${VIRTUAL_ENV_PROMPT:+$VIRTUAL_ENV_PROMPT}\[\033[38;5;153m\]\u@\h\[\033[00m\] \[\033[38;5;209m\]\w$(__git_ps1 " \[\033[03;38;5;250m\](git: %s)\[\033[00m\]")\n\[\033[38;5;153m\]\$ \[\033[00m\]'
else
